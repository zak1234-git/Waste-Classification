...
input_size = (224, 224)
labels = ['other', 'recycle', 'harm', 'kitchen']
anchors = [2.41, 2.09, 1.69, 1.34, 2.62, 4.59, 1.75, 2.34, 5.55, 4.89]
...
class Comm:
    def __init__(self, uart):
        self.uart = uart
        self.counter = 0
        self.send_interval = 10  # 每 10 帧发送一次
...
if __name__ == "__main__":
    try:
        ...
        main(anchors = anchors, labels=labels, model_addr="/sd/model-83588.kmodel")
    except Exception as e:
